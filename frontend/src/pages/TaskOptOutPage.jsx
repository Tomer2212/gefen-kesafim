...
// Mirrors UnsubscribePage.jsx's flow exactly, but hits PATCH /tasks/opt-out and suppresses
// the contact from Tasks messages specifically — unrelated to the marketing-leads list
// UnsubscribePage manages.
export default function TaskOptOutPage() {
  ...
  useEffect(() => {
    ...
    axios.patch("/tasks/opt-out", { email, token })
          ...
          {status === "success" && (
            <>
              ...
              <p className="text-sm text-slate-500 leading-relaxed mb-6">
                כתובת המייל שלך הוסרה מרשימת התפוצה של הודעות משימות.
              </p>
